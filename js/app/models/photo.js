define(function (require) {
    ...
    var Backbone            = require('backbone'),
        ...
        PhotoCollection = Backbone.Collection.extend({
            ...
            url: function(){
                return 'https://api.flickr.com/services/rest/?&method=flickr.photosets.getPhotos&api_key='+this.flickr_api_key+'&user_id='+this.flickr_user_id+'&extras=url_sq,url_t,url_s,url_m,url_o&photoset_id='+this.photoset_id;                    
            },
