define(function (require) {
    ...
    var Backbone            = require('backbone'),
        ...
        EventCollection = Backbone.Collection.extend({
            ...
            url: function(){
                    if(constants.mode===false){
                        return 'https://www.google.com/calendar/feeds/dife.edu@gmail.com/public/full?orderby=starttime&sortorder=ascending&max-results=10&futureevents=true'
                    }
                    else{
                        return "/school-proxy.php?context=events";
                    }
            },
