define(function (require) {
    ...
    return Backbone.Router.extend({
        ...
        routes: {
            ...
            "press": "getGeneric",
            "press-item/:id": "getGenericItem",
            "sport": "getGeneric",
            "sport-item/:id": "getGenericItem",
            "awards": "getGeneric",
            "awards-item/:id": "getGenericItem",
            "careers": "getGeneric",
            "careers-item/:id": "getGenericItem",
            ...
            $.ajaxPrefilter( function( options, originalOptions, jqXHR ) { 
                ...
                if(options.api==true){
                    ...
                    if(in_browser===true){
                        ...
                        options.url = 'http://localhost/schoolspace/cli/'+constants.project_title+'/www/scripts' + options.url   
                    }
                }
        ...
        setDeviceDetails: function(){
            ...
            this.device_id = this.storage.getItem(constants.project_title+'_device_id');
            this.api_key = this.storage.getItem(constants.project_title+'_api_key');
        },
        ...
        updateMessageCounter: function(){
            ...
            require(["app/models/article_view"], function (models) {
                ...
                var article_view_count = new models.ArticleViewCount({device_id: that.device_id, 
                                                                      project_title: constants.project_title
                                                                        });
            ...
            require(["app/models/generic", "app/views/GenericList"], function (model, GenericList) {
                    ...
                    generic.fetch({
                        ...
                        success: function (collection) {
                            ...
                            console.log('in generic success and collection is ');
        ...
        getGenericItem: function (id) {
            ...
            require(["app/views/GenericItem"], function (GenericItem) {
                ...
                console.log('generic get is');
                console.log(generic.models[0].attributes.posts[id]);

                Useful.correctView(that.body);
                 slider.slidePage(new GenericItem({model: generic.models[0].attributes.posts[id]}).$el);
        ...
        getTweets: function () {
            ...
            require(["app/views/TweetList"], function (Twitter) { 
                Useful.correctView(that.body);
                slider.slidePage(new Twitter().$el);               
             });
        },
            ...
            require(["app/models/article", "app/views/ArticleList"], function (models, ArticleList) {
                ...
                if(typeof(articles)==='undefined' || articles===null){
                    ...
                    if(typeof(that.device_id)!=='undefined' && that.device_id!==null){
                        ...
                        articles = new models.ArticleCollection({device_id: that.device_id, project_title: constants.project_title
                                                                });
        ...
        setProjectDetailsWait: function(){
                    ...
                    project = new projectModel.Project({id:constants.project_title});
